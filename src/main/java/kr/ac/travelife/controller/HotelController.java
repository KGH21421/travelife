...
import kr.ac.travelife.service.HotelService;
import kr.ac.travelife.util.Pager;

@Controller
@RequestMapping("/hotel")
public class HotelController {
	final String path = "hotel/";
	...
	public String list(Pager pager, Model model) {
		List<Hotel> list = service.list(pager);
	...
	@PostMapping("/add")
	public String add(Hotel notice, @SessionAttribute Member member) {
	...
	public String view(@PathVariable int code, Model model,Pager pager) {
		List<Hotel> list=service.list(pager);
		Hotel notice = service.notice(code);
	...
	public String update(@PathVariable int code, Hotel notice) {
